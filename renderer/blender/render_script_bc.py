"""
blender render_script_savio.py  --obj_file meshes/code_gt_6.obj --layout_file meshes/layout_gt_6.obj --hostname vader --r 2 --delta_theta 30
blender --background --python render_script_bc.py
"""
...
def parse_args(str_arg):
  ...
  parser.add_argument('--obj_file', type=str, default='meshes/test.obj')
...
if __name__ == '__main__':
  ...
  tmp_file = os.path.join('render_tmp', 'bpy-' + str(os.getpid()) + '.' + args.format)
  exr_files = None;
