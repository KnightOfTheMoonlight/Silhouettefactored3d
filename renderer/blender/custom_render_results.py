"""
/home/li216/anaconda3/envs/bpy35/bin/python custom_render_results.py  --obj_files data/objs/gt_codes.obj --hostname vader --r 2 --delta_theta 30 --out_dir rendering_test --out_name_prefix test --add_objects_one_by_one 1 --sz_x 320 --sz_y 240
"""
import os, sys
