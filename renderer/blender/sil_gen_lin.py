"""
/home/li216/anaconda3/envs/bpy35/bin/python render_script.py  --obj_file meshes/code_gt_6.obj  --hostname vader --r 2 --delta_theta 30
"""
...
if __name__ == '__main__':
  ...
  if write_png_jpg:
      ...
      for i in range(len(ims)):
          ...
          mask_path = os.path.join(jpg_dir, '{:s}_render_{:03d}_mask.png'.format(name, i))
          scipy.misc.imsave(mask_path, masks[i])
